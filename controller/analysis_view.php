...
<head>
  ...
  <title>Analysis | Dell Inventory</title>
  <link rel="icon" href="https://www.freeiconspng.com/uploads/black-dell-logo-icon-png-3.png" type="image/x-icon">
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
	  <td><a class="btn btn-primary" href="analysis_report.php?course_id=<?php echo $course_id; ?>">Download Report</a></td>
	  <br><br>
        <div class="row">
          <div class="col-12">
