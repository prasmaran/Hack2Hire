        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              $default = mysqli_query($mysqli, "SELECT * FROM invalidproduct where modelID = '$oldmodelID'");
			  $delete = mysqli_query($mysqli, "DELETE FROM invalidproduct where modelID = '$oldmodelID'");
